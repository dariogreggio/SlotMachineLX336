...
********************************************************************
 ...
 Change History:
  Rev   Description
  ----  -----------------------------------------
  1.0   Initial release, basata su LX336 (n. 65/1979) di Nuova Elettronica
...
static rom const char CopyrString[]= {'C','y','b','e','r','d','y','n','e',' ','(','A','D','P','M',')',' ','-',' ','S','l','o','t','M','a','c','h','i','n','e',' ','L','X','3','3','6',' ',
	VERNUMH+'0','.',VERNUML/10+'0',(VERNUML % 10)+'0', ' ','0','9','/','0','5','/','2','2', 0 };
...
//	IPR1bits.TMR2IP = 0;				// Timer-2 Low Pty NON USATO
	...
	Displays[0][0]=Displays[1][0]=Displays[2][0]=Displays[3][0]=Displays[4][0]=0x00;
	Displays[0][1]=Displays[1][1]=Displays[2][1]=Displays[3][1]=Displays[4][1]=0x00;
	...
	//			T2CONbits.TMR2ON=0;
		...
		if(first) {			// lascia Splash per un po'..
			...
			if(first>((BASE_FIRST/2)-1)) {
				...
				showChar(0,VERNUMH+'0',1,0);
				showChar(0,VERNUML+'0',0,0);
				}
...
/*			{ BYTE n=rand();
			Displays[0][0] = 0b00000000;
			Displays[1][0] = n & 2 ? 0b01000000 : 0b00000000;
			Displays[2][0] = n & 1 ? 0b01000000 : 0b00000000;
			Displays[3][0] = n & 4 ? 0b01000000 : 0b00000000;
			Displays[4][0] = 0b00001000;
			}*/
			{ BYTE n=dividerT % 3;
			Displays[0][0] = 0b00000000;
			switch(n) {
